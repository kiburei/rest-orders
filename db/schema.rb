...
ActiveRecord::Schema.define(version: 2018_09_24_065329) do
  ...
  create_table "order_items", primary_key: "order_items_id", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "order_id"
    t.bigint "menu_id"
